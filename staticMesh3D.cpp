...
const int StaticMesh3D::NORMAL_ATTRIBUTE_INDEX             = 1;
const int StaticMesh3D::TEXTURE_COORDINATE_ATTRIBUTE_INDEX = 2;


StaticMesh3D::StaticMesh3D(bool withPositions, bool withNormals, bool withTextureCoordinates)
